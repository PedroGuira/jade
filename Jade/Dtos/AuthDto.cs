...
namespace Jade.Dtos
{
    ...
    public class LoginResponseDto
    {
        ...
        public string UserId { get; set; } // Pode ser string ou int dependendo do seu IdentityUser
        public string Email { get; set; }
        public string NomeCompleto { get; set; }
        public string Role { get; set; } // Adicionado
        public int? EstabelecimentoId { get; set; } // Já existia, mas pode ser null
        public int? MarcaFranquiaId { get; set; } // Adicionado, pode ser null
    }
}
